...
import { deleteRequest, getRequest, putRequest } from "../../../../../config/apiFunctions";
import { toast } from "react-toastify";

const ReusableTabTable = ({
  title,
  activeTab,
  fetchData,
  tableHeadings,
  ...
  const [debouncedSearchText, setDebouncedSearchText] = useSearchDebounce();
  ...
  useEffect(() => {
    userListCallBack();
  }, [currentPage, rowsPerPage, searchTextDebounce, roleId, activeTab]);
  ...
  return (
    <div>
      ...
      <SearchBar
        ...
        handleChangeSearchText={handleSearchChange}
...
export default ReusableTabTable;

...
//       // Include edited Arabic fields if they exist
...
//       form.append("link", watch("url"));
//       form.append("banner_image", watch("icon"));
...
//             )}
//             <p
//               className={`text-sm mt-1 ml-auto ${(watch("title")?.length || 0) > 70 ? "text-red-500" : "text-gray-500"
//                 }`}
//             >
...
//             )}
//             <p
//               className={`text-sm mt-1 ml-auto ${(watch("subtitle")?.length || 0) > 90 ? "text-red-500" : "text-gray-500"
//                 }`}
//             >

...
const Banner = () => {
  ...
  async function getBannerList(url) {
    setLoading(true);
    try {
  ...
  const bannerListCallBack = () => {
    getBannerList(
      `${BANNER.LIST}?currentPage=${currentPage}&limit=${rowsPerPage}&search=${searchTextDebounce}`
    );
  };
  ...
  return (
    <>
      ...
      <div className="flex justify-between items-center mb-3">
        <h1 className="font-semibold text-xl">{TITLES?.BANNER.root}</h1>
      ...
      <div className="relative w-full overflow-x-auto hide-scrollba">
        <div className="min-w-[900px]">
          <table className="w-full text-left rtl:text-right text-gray-500 dark:text-gray-400">
            <TableHead headLable={BANNER_TABLE_HEAD} />
      ...
      <CreateBannerModel
        ...
        userListCallBack={bannerListCallBack}
      />

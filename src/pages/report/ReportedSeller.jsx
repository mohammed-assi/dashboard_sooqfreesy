...
import ReportSellerTableBody from "./ReportSellerTableBody";
...
const ReportedSeller = () => {
  ...
  const postListCallBack = () => {
    getAllPosts(
      `${REPORT.LIST}?page=${currentPage}&limit=${rowsPerPage}&search=${searchTextDebounce}&reportType=SELLER`
    );
  };
  ...
  return (
    <>
      <PageMeta title={TITLES?.REPORT.seller_report} description="Dashboard" />

     <div className="flex gap-2 items-center">
        <BackButton />
        <h1 className="font-semibold text-xl">
          {TITLES?.REPORT.seller_report}
        </h1>
      </div>
        ...
        <div className="relative w-full overflow-x-auto hide-scrollba">
          <div className="min-w-[900px]">
            <table className="w-full text-left rtl:text-right text-gray-500 dark:text-gray-400">
              <TableHead headLable={REPORT_SELLER_TABLE_HEAD} />
              <ReportSellerTableBody
                postList={postList}
